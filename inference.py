...
train_A = load_data('/root/OpenSourceSW-Project/trainA/*')
train_B = load_data('/root/OpenSourceSW-Project/trainB/*')
print(len(train_A))
print(len(train_B))

val_A = load_data('./data/trainA/*')
val_B = load_data('/data/trainB/*')
...
pred_A = load_data('./data/trainA/prac_2.jpg')
val_pred = load_data('./data/trainA/prac_2.jpg')

val_batch = minibatchAB(pred_A, val_B, batch_size=1)
